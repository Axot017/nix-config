...
-- Clipboard
vim.keymap.set('n', '<C-y>', '"+y', { silent = true, desc = 'Yank to system clipboard' })
vim.keymap.set('n', '<C-p>', '"+p', { silent = true, desc = 'Paste from system clipboard' })
...
vim.keymap.set('n', '<leader>X', function() Snacks.bufdelete.other() end, { silent = true, desc = 'Delete other buffers' })
...
vim.keymap.set('v', '<C-y>', '"+y', { silent = true, desc = 'Yank to system clipboard' })
vim.keymap.set('v', '<C-p>', '"+p', { silent = true, desc = 'Paste from system clipboard' })
vim.keymap.set('v', 'p', '"_dP', { silent = true, desc = 'Paste without yanking' })

-- Visual block mode
vim.keymap.set('x', '<C-y>', '"+y', { silent = true, desc = 'Yank to system clipboard' })
vim.keymap.set('x', '<C-p>', '"+p', { silent = true, desc = 'Paste from system clipboard' })
